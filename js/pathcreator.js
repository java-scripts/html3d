...
angular.module('css3d').controller('myController',['$scope',function(s){  
	...
	s.os={startNode:'n1',endNode:'n2',locateNode:'n1',showCurrentNode:true};
	
	
	s.addToPath = function(){
	
		if(s.os.currentNodeName && s.os.currentNodeName !== ""){
			var x = s.$parent.l.t.x;
			var y = s.$parent.l.t.y;
			var z = s.$parent.l.t.z;
			var ry = s.$parent.l.r.y;
			
			
			//nodeMap
			var prevNodeName = s.os.locateNode;
			var prevNode = nodeMap[prevNodeName];
			var currentNodeName = s.os.currentNodeName;
			var showCurrentNode = s.os.showCurrentNode;		
			
			var currentNode = { p:{x:x,y:y,z:z,ry:ry},paths:{},show:showCurrentNode};
			
			//connect 2way path between 
			currentNode.paths[prevNodeName]=0;
			prevNode.paths[currentNodeName]=0;
			
			//add current node to node map
			nodeMap[currentNodeName] = currentNode;
			
			s.os.locateNode = currentNodeName;
			s.os.currentNodeName = "";
